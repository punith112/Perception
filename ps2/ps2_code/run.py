...
def get_cli_args():
    parser = ArgumentParser('Runs localization filters (EKF, UKF, or PF) on generated, simulation data.')
    ...
    parser.add_argument('-a',
                        ...
                        metavar=('A1', 'A2', 'A3', 'A4'),
                        action='store',
                        help='Squared root of alphas, used for motion noise. (format: a1 a2 a3 a4).',
                        default=(0.05, 0.001, 0.05, 0.01))
    parser.add_argument('-b',
                        '--beta',
                        type=float,
                        action='store',
                        help='Observation noise, standard deviation  (format: deg).',
                        default=20)
...
def main():
    ...
    elif args.filter_name == 'ukf':
        localization_filter = UKF(initial_state, alphas, beta)
